...
/**
 * Strings for component 'kuet', language 'es', version '4.5'.
 *
 * @package     kuet
 * @category    string
...
$string['timemode_help'] = 'Hay que tener en cuenta que el tiempo por pregunta corresponde al tiempo permitido para responder. Una vez que se responda, se parará el tiempo <br><br><b> Sin tiempo: </b> No hay límite de tiempo para finalizar la sesión. El tiempo por pregunta se puede configurar en algunas o ninguna desde el panel de preguntas <br><b>Tiempo total por sesión:</b> Cada pregunta tendrá el mismo tiempo para responder (este valor se dividirá entre el número de preguntas) <br><b>Tiempo pro pregunta:</b> Este valor será el de por defecto de cada pregunta. (En cada pregunta se podrá modificar dicho valor) <br><br><b>Importante:</b> Si durante una pregunta con tiempo definido, el alumno cierra el navegador o refresca la página, esa pregunta será considerada no enviada (por considerarse un intento de ganar tiempo para contestar).';
