...
/**
 * Strings for component 'certificatebeautiful', language 'es', version '4.5'.
 *
...
$string['autogenerate_help'] = 'Cuando está habilitado, la tarea programada creará automáticamente las emisiones de certificados y los archivos PDF.';
$string['autogenerate_task_name'] = 'Generación automática de Certificate Beautiful';
$string['automationheader'] = 'Generación automática de certificados';
...
$string['autotrigger_activitycompletion'] = 'Finalización de la actividad';
...
$string['deletedmodel'] = 'El modelo "{$a}" ha sido eliminado correctamente.';
...
$string['gradepass_required'] = 'Debe definir una calificación final mínima del curso numérica.';
...
$string['notification_body'] = 'Hola {$a->fullname},<br><br>Su certificado <strong>{$a->certificatename}</strong> para el curso <strong>{$a->coursename}</strong> ya está disponible.<br><br>Acceda aquí: <a href="{$a->url}">{$a->url}</a>';
$string['notification_subject'] = 'Su certificado está disponible: {$a->certificatename}';
$string['notifyuser'] = 'Enviar notificación por correo electrónico cuando se emita el certificado';
...
$string['subplugintype_certificatebeautifuldatainfo'] = 'Subplugin de Certificate Beautiful';
...
$string['triggercmid_required'] = 'Debe elegir una actividad para el disparador de finalización de la actividad.';
