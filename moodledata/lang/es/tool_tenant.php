...
/**
 * Strings for component 'tool_tenant', language 'es', version '4.5'.
 *
 * @package     tool_tenant
 * @category    string
...
$string['activateusers'] = 'Activar usuarios';
$string['activateusersintotenant'] = 'Activar usuarios en el micrositio...';
...
$string['confirmarchivetenantwithoutusers'] = '¿Estás seguro de querer archivar el micrositio \'{$a}\'?';
$string['confirmarchivetenantwithusers'] = '¿Estás seguro de querer archivar el micrositio \'{$a->tenant}\'? {$a->users} usuario(s) asignados a este micrositio serán suspendidos.';
...
$string['reg_wptenantdomains'] = 'Número de micrositios con url personalizada configurada ({$a})';
...
$string['tenantarchivedsuccess'] = '¡El micrositio \'{$a}\' fue archivado! Todos sus usuarios fueron suspendidos.';
...
$string['tenantdeleted'] = 'El micrositio \'{$a}\' ha sido eliminado.';
...
$string['tenantrestoredsuccess'] = '¡El micrositio \'{$a->tenant}\' fue restaurado! Todos los usuarios asignados a este micrositio ahora están activos. <a href="{$a->link}">Gestionar usuarios</a>.';
...
$string['wwwroot'] = 'Dominio personalizado';
$string['wwwroot_help'] = 'URL específica que debe utilizarse para este micrositio. Antes de hacerlo, es necesario asegurarse que el DNS ya está configurado para que la URL apunte al mismo sitio.';
