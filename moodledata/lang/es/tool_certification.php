...
/**
 * Strings for component 'tool_certification', language 'es', version '4.5'.
 *
...
$string['certificationslink'] = '<a href="{$a->href}">{$a->count} certificación</a>';
$string['certificationslink_plural'] = '<a href="{$a->href}">{$a->count} certificaciones</a>';
...
$string['certifiedandrevoked'] = 'Certificado y revocado';
...
$string['currentcertification'] = 'Certificación actual';
...
$string['historicalcertificationcompletion'] = 'Historial de finalización de certificaciones de los usuarios';
$string['historicalstatus'] = 'Estatus histórico';
