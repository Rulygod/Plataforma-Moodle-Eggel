...
$string['setupfactor:link_help'] = 'Este enlace puede funcionar si usted está en un dispositivo móvil y ya tiene una app de autenticación instalada. Comprenda que usar TOTP en el mismo dispositivo en que se autentica debilita las ventajas del MFA.';
