...
/**
 * Strings for component 'format_onetopic', language 'es', version '4.5'.
 *
...
$string['cli_migratestylesend'] = 'La migración de estilos se completó correctamente.';
$string['cli_migratestylesstart'] = 'Iniciando la migración de estilos...';
$string['cli_migratestylesstarttitle'] = 'Migración de estilos...';
...
$string['migratecssstyles'] = 'Estilos';
$string['migratestyles'] = 'Migración de estilos';
$string['migratestylesaction'] = 'Migrar estilos';
$string['migratestylesall'] = 'Mostrar todas las secciones';
$string['migratestylesconfirm'] = '¿Seguro que quieres migrar los estilos? Esta acción migrará los estilos del formato antiguo al nuevo, y no se podrá deshacer. Los estilos antiguos se conservarán por motivos de compatibilidad.';
$string['migratestylesdone'] = 'La migración de estilos se completó correctamente.';
$string['migratestyleslimit'] = 'Se ha superado el número de registros que se pueden mostrar en pantalla. Solo se muestran los primeros {$a} registros.';
$string['migratestylesnothing'] = 'No hay estilos que migrar.';
$string['migratestylesonlytochange'] = 'Mostrar solo las secciones que están pendientes de migración.';
$string['migratewillbemigrated'] = 'Será migrado';
$string['migrationpagehelp'] = 'Puede usar la siguiente página para revisar qué estilos existen en el control antiguo: <a href="{$a}" target="_blank">Migración</a>. También puede usar la función de migración automática si hay estilos que se pueden migrar. Los estilos no se pueden migrar si la nueva propiedad ya existe en la base de datos.';
...
$string['nomigratestyles'] = 'No hay estilos que migrar.';
