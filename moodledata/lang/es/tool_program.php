...
/**
 * Strings for component 'tool_program', language 'es', version '4.5'.
 *
...
$string['allownewallocations'] = 'Permitir nuevas asignaciones';
...
$string['direct'] = 'Asignación directa';
$string['directallocation'] = 'Asignación directa (Manual)';
...
$string['errornopermissiontoeditprogramdetails'] = 'Sin permiso para editar los detalles del programa';
...
$string['overduex'] = '{$a} atrasado';
$string['parentname'] = 'Nombre del superior';
$string['paymentaccount'] = 'Cuenta de pago';
$string['paymentaccount_help'] = 'Seleccionar la cuenta de pago que se utilizará para este método de asignación. Los pagos serán procesados a través de la cuenta elegida.';
...
$string['price'] = 'Precio';
$string['price_help'] = 'Establecer el precio que los usuarios deben pagar para auto asignarse en este programa. Ingresar el monto en el formato 0.00 (ej., 25.00).';
$string['priceerror'] = 'El precio debe ser un número.';
...
$string['program:configfeeallocation'] = 'Configurar instancias de asignación pagas';
$string['program:configselfallocation'] = 'Configurar instancias de métodos de automatriculación';
...
$string['program:manageuserfeeallocations'] = 'Permitir editar y eliminar métodos de asignación';
$string['program:manageuserselfallocations'] = 'Permitir editar y eliminar auto-asignación de los usuarios';
...
$string['programscountwithoutcategory'] = '{$a->count} programa(s) no están actualmente asociados a una categoría en el Catálogo';
$string['programscustomfield'] = 'Campos personalizados de programas';
$string['programsetname'] = 'Nombre del conjunto';
$string['programsincategoryx'] = 'Programas en la categoría \'{$a}\'';
$string['programslink'] = '<a href="{$a->href}">{$a->count} programa</a>';
$string['programslink_plural'] = '<a href="{$a->href}">{$a->count} programas</a>';
$string['programsnotlistedincatalogue'] = 'Programas no listados en el Catálogo';
...
$string['programvisibilityincatalogue'] = 'Visibilidad del programa en el Catálogo';
...
$string['showprograms'] = 'Mostrar programas';
$string['showprogramslisted'] = 'Mostrar programas listados en el Catálogo con la categoría \'{$a}\'';
$string['showprogramsnotlisted'] = 'Mostrar programas no listados en el Catálogo';
