...
/**
 * Strings for component 'jitsi', language 'es', version '4.5'.
 *
 * @package     jitsi
 * @category    string
...
$string['sharedsessionwithtoken'] = 'Compartir sesión con otro curso';
...
$string['tokeninvitacion'] = 'Sesión a la que acceder';
$string['tokeninvitacion_help'] = 'Busque por nombre de actividad, nombre d ecurso o nombre corto y seleccione la sessión a la que desee unirse. También puede pegar un token compartido por otro docente para unirse a su sesión. Los estudiantes de este curso entrarán en la misma sala que esa sesión.';
