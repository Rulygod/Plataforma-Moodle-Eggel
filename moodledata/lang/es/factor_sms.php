...
$string['notification:smsgatewaymigration'] = 'Se han migrado los ajustes de SMS';
$string['notification:smsgatewaymigrationinfo'] = 'Ahora hay un nuevo subsistema SMS disponible para gestionar y configurar todas las funciones relacionadas con SMS. Sus configuraciones SMS existentes han sido migradas a la página <a href="{$a}">Puertas de enlace SMS</a>.';
...
$string['settings:gateway'] = 'Puerta de enlace SMS';
$string['settings:gateway_help'] = 'El proveedor de SMS a través del cual desea enviar mensajes';
$string['settings:heading'] = 'Durante su autenticación, los usuarios recibirán un SMS con un código de seis dígitos que deberán introducir para completar el proceso.

Los usuarios tendrán que haber registrado su número de teléfono móvil previamente.';
$string['settings:setupdesc'] = 'Para usar SMS como factor de autenticación, antes tiene que <a href="{$a}">configurar una puerta de enlace SMS</a>.';
$string['settings:smsgateway'] = 'Puerta de enlace SMS';
$string['settings:smsgateway_help'] = 'Seleccione una puerta de enlace de la lista, o  <a href="{$a}">cree una nueva puerta de enlace</a>.';
