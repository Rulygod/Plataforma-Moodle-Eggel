...
/**
 * Strings for component 'goodhabits', language 'es', version '4.5'.
 *
 * @package     goodhabits
 * @category    string
...
$string['dyk_add_entry_2'] = 'Esto abre una rejilla para permitirte reflexionar sobre un hábito para un/a {$a} en concreto.';
...
$string['dyk_cal_unit_options_2'] = 'Esto te mostrará más opciones para {$a}';
$string['dyk_cal_unit_options_3'] = 'Puedes contestar preguntas acerca de cada hábito en secuencia para {$a}';
$string['dyk_cal_unit_options_5'] = '{$a} es un ejemplo de descanso. Estos se pueden gestionar en *Gestionar descansos*, más abajo. También puedes añadir un descanso más largo.';
...
$string['freq_desc'] = 'Predeterminado de la actividad : Con qué frecuencia deseas que las personas que usan esto agreguen entradas de hábitos.';
...
$string['get_started'] = '¿Te hace falta ayuda para comenzar? Responder preguntas sobre los últimos {$a}.';
...
$string['mobile_view'] = 'Vista móvil';
...
$string['no_habits'] = 'Parece que aún no tienes ningún hábito establecido: puedes añadir algunos aquí';
...
$string['overlay_1_2'] = 'Hacer más con menos';
$string['overlay_1_3'] = 'Llegar lejos con esfuerzo';
$string['overlay_2_1'] = 'Disfrutar ganancias fáciles';
$string['overlay_2_2'] = 'Avanzar a un buen ritmo';
$string['overlay_2_3'] = 'Superar los obstáculos';
$string['overlay_3_1'] = 'Cada paso cuenta';
...
$string['review_no_habits'] = 'Parece que este usuario aún no tiene ningún hábito configurado';
...
$string['show_scores_help'] = 'Si deseas mostrar los números que has introducido en la cuadrícula.
<br /><br />Por ejemplo: <span style="font-weight: bold">6 / 7</span>.
<br /><br />Si ocultas esta opción, aún puedes obtener una idea general de los valores a partir de los colores.';
